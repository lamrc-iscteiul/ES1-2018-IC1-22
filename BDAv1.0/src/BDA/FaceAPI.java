...
public class FaceAPI {
	...
	/**
	 * Reads the AcessToken from the XML file, connects to the facebook page and
	 * gets the list of posts made by the page ES-2018.
	 */
	...
	public static String postToString(Post post) {
		String s = post.getCreatedTime() + " - ES-2018" + System.lineSeparator()
				+ "---------------------------------------------------------------------------------------"
				+ System.lineSeparator() + post.getMessage();
		return s;
	}
