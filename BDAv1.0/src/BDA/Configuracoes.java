...
public class Configuracoes {
	...
	private JCheckBox chckbxh_1;
	private JCheckBox chckbxDias;
	private JCheckBox chckbxIscteiul;
	private JCheckBox chckbxBiblioteca;
	private JCheckBox chckbxElearning;
	private JCheckBox chckbxReitora;
	private JCheckBox chckbxFenix;
	private JCheckBox chckbxTesouraria;
	private JCheckBox chckbxTudo;

	/**
	 * Launches the Config window. Used for testing purposes.
	 */
	...
	private void initialize() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				configXML.setTwitter(text_twitter_consumerkey.getText(), text_twitter_consumersecret.getText(),
						text_twitter_accesstoken.getText(), text_twitter_accesstokensecret.getText());
				try {
					guardarXML();
		...
		btnSalvar_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				configXML.setFiltros(chckbxh.isSelected(), chckbxh_1.isSelected(), chckbxDias.isSelected(),
						chckbxIscteiul.isSelected(), chckbxBiblioteca.isSelected(), chckbxElearning.isSelected(),
						chckbxReitora.isSelected(), chckbxFenix.isSelected(), chckbxTesouraria.isSelected(),
						chckbxTudo.isSelected());
				try {
					guardarXML();
				} catch (JAXBException e) {
					e.printStackTrace();
	 ...
	 * @return String
	 */
	public String getText_email_user() {
